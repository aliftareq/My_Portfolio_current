...
export default function Page() {
  ...
  useEffect(() => {
    if (course && !isInitialized) {
      setForm({
        ...
        completionDate: formatDateForInput(course.completionDate),
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(updateCourse({ id, updatedData: cleanedForm }));
  };
  ...
  const previewThumbnail = uploadedThumbnailUrl || course?.thumbnail || "";
