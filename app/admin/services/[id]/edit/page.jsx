...
export default function Page() {
  ...
  const handleSubmit = (e) => {
    ...
    const cleanedForm = {
      ...form,
      icon: uploadedLogoUrl || service?.icon || "",
    };

    dispatch(updateService({ id, updatedData: cleanedForm }));
  };
  ...
  const previewLogo = uploadedLogoUrl || service?.icon || "";

  return (
    <div className="min-h-screen py-10 text-white">
      <div className="container mx-auto max-w-5xl">
        <h1 className="mb-8 text-3xl font-bold">Edit Service</h1>
